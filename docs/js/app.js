import { INITIAL_SINGULARITIES, PRESET_PROMPTS, DEFAULT_G, DEFAULT_EPSILON, DEFAULT_DELTA, DEFAULT_LAGRANGE_THRESHOLD } from "./constants.js?v=6.2";
import { ClientEmbedder } from "./embedder.js?v=6.2";
import { GravitationalEngine } from "./physics.js?v=6.2";
import { ModelResponseGenerator } from "./generator.js?v=6.2";
