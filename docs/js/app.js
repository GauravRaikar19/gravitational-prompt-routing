import { INITIAL_SINGULARITIES, PRESET_PROMPTS, DEFAULT_G, DEFAULT_EPSILON, DEFAULT_DELTA, DEFAULT_LAGRANGE_THRESHOLD } from "./constants.js?v=7.1";
import { ClientEmbedder } from "./embedder.js?v=7.1";
import { GravitationalEngine } from "./physics.js?v=7.1";
import { ModelResponseGenerator } from "./generator.js?v=7.1";
